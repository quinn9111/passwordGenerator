// Assignment code here
  ...
  var lengthPassword = window.prompt("Please insert numeric length of password between 8 to 128 characters");
  lengthPassword = parseInt(lengthPassword);
  
  if (lengthPassword>128 ){
  alert("Insert a numeric value less than 128");
  generateBtn.disabled=true;
}

else if (lengthPassword<8){
  alert("Insert a numeric value greater than 8");
  generateBtn.disabled=true;
}
